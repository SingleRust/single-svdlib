    ...
    fn multiply_with_dense_centered(
        ...
        if !transpose_self {
            ...
            let correction: Vec<T> = (0..dense_cols)
                .map(|c| {
                    (0..ncols).fold(T::zero(), |acc, j| acc + means[j] * dense[(j, c)])
                })
                .collect();
...
mod tests {
    ...
    fn test_transposed_by_dense_csr() {
        ...
        assert_mat_close(
            &result,
            &[
                (0, 0, 1.0),  (0, 1, 27.0), (0, 2, 9.0),  (0, 3, 42.0),
                (1, 0, 2.0),  (1, 1, 34.0), (1, 2, 12.0), (1, 3, 52.0),
            ],
        );
    }
    ...
    fn test_transposed_centered() {
        ...
        assert_mat_close(
            &result,
            &[
                (0, 0, -3.5), (0, 1, 18.0), (0, 2, -4.5), (0, 3, 24.0),
                (1, 0, -4.0), (1, 1, 22.0), (1, 2, -6.0), (1, 3, 28.0),
            ],
        );
    }
}
